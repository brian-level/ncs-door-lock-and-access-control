...
extern       uint8_t UWB_RANGE_STOP_NTF[];
extern const uint32_t UWB_RANGE_STOP_NTF_SIZE;
extern       uint8_t UWB_RANGE_START_NTF[];
extern const uint32_t UWB_RANGE_START_NTF_SIZE;
